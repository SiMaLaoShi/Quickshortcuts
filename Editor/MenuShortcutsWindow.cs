...
public class MenuShortcutsWindow : EditorWindow
{
    ...
    private static List<KeyValuePair<string, string>> SearchAllMenuItems()
    {
        ...
        {
            //Debug.Log("assemblies:" + assemblies[i].FullName);
            if (assemblies[i].GetName().Name == "HWUtility")
                continue;
        ...
        //     {
        //         var attrs = ms[n].GetCustomAttributes(typeof(MenuItem), false);
        //         if (attrs.Length > 0)
        //             for (var m = 0; m < attrs.Length; ++m)
        //             {
        //                 var attr = attrs[m] as MenuItem;
        //                 if (!string.IsNullOrEmpty(attr.menuItem))
        //                     if (set.Add(attr.menuItem))
        //                         ret.Add(new KeyValuePair<string, string>(attr.menuItem, assembly.GetName().Name));
        //             }
        //     }
        // }
